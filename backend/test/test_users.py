...
def test_create_user_sucess():
    ...
    response = client.post(
        "/users", json={"email": "emailsucess@gmail.com", "password": "Senha@Forte123"}
    )
...
def test_duplicate_email():
    ...
    """
    client.post(
        "/users", json={"email": "emailteste@gmail.com", "password": "Senha@Forte123"}
    )

    # Tenta criar um segundo usuário com o mesmo email
    response = client.post(
        "/users", json={"email": "emailteste@gmail.com", "password": "OutraSenha123@"}
    )
...
def test_local_part_empty():
    ...
    """
    response = client.post(
        "/users", json={"email": "@gmail.com", "password": "Senha@Forte123"}
    )
...
def test_local_part_contains_space():
    ...
    """
    response = client.post(
        "/users", json={"email": "email teste@gmail.com", "password": "Senha@Forte123"}
    )
...
def test_domain_contains_space():
    ...
    """
    response = client.post(
        "/users", json={"email": "emailteste@gm ail.com", "password": "Senha@Forte123"}
    )
...
def test_domain_contains_underscore():
    ...
    """
    response = client.post(
        "/users", json={"email": "emailteste@gmail_.com", "password": "Senha@Forte123"}
    )
...
def test_domain_empty():
    ...
    """
    response = client.post(
        "/users", json={"email": "emailteste@.com", "password": "Senha@Forte123"}
    )
...
def test_tld_contains_space():
    ...
    """
    response = client.post(
        "/users", json={"email": "emailteste@gmail.co m", "password": "Senha@Forte123"}
    )
...
def test_tld_contains_digits():
    ...
    """
    response = client.post(
        "/users", json={"email": "emailteste@gmail.com2", "password": "Senha@Forte123"}
    )
...
def test_tld_length():
    ...
    """
    response = client.post(
        "/users", json={"email": "emailteste@gmail.c", "password": "Senha@Forte123"}
    )
...
def test_password_length():
    ...
    """
    response = client.post(
        "/users", json={"email": "emailteste@gmail.com", "password": "Ab1!L()"}
    )
...
def test_password_uppercase():
    ...
    """
    response = client.post(
        "/users", json={"email": "emailteste@gmail.com", "password": "test123!@"}
    )
...
def test_password_digit():
    ...
    """
    response = client.post(
        "/users", json={"email": "emailteste@gmail.com", "password": "TEST!@test"}
    )
...
def test_password_special_character():
    ...
    """
    response = client.post(
        "/users", json={"email": "emailteste@gmail.com", "password": "TEST123test"}
    )
